...
class ForeignerModel:
    ...
    def mapper(self, prop, classes):
        ...
        if prop.relationship == "ManyToMany":
            ...
            self.baseColumn = prop.foreignerPropertyAlias #u"{0}_{1}".format(self.baseTable, basePrimary.extend.alias).lower()
            ...
            self.referenceColumn = prop.extend.alias #u"{0}_{1}".format(self.referenceTable, refPrimary.extend.alias).lower()
